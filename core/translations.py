...
TEXTES: dict[str, dict[str, str]] = {
    ...
    "fr": {
        ...
        "map_periode_ref":          "Période actuelle (1970-2000)",
        ...
        "map_titre_carte_current":  "{espece}  ·  Période actuelle (1970-2000)",
    ...
    "en": {
        ...
        "map_periode_ref":          "Current period (1970-2000)",
        ...
        "map_titre_carte_current":  "{espece}  ·  Current period (1970-2000)",
        "map_titre_carte_futur":    "{espece}  ·  {periode} | {ssp}",
    ...
    "es": {
        ...
        "map_periode_ref":          "Período actual (1970-2000)",
        ...
        "map_titre_carte_current":  "{espece}  ·  Período actual (1970-2000)",
        "map_titre_carte_futur":    "{espece}  ·  {periode} | {ssp}",
    ...
    "ca": {
        ...
        "map_periode_ref":          "Període actual (1970-2000)",
        ...
        "map_titre_carte_current":  "{espece}  ·  Període actual (1970-2000)",
        "map_titre_carte_futur":    "{espece}  ·  {periode} | {ssp}",
